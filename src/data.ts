...
export const faqs = [
  {
    ...
    a: 'Измерьте длину стопы в сантиметрах вечером и сверьтесь с нашей таблицей размеров. Если сомневаетесь — откройте помощник подбора на сайте: подскажем размер по модели и полноте стопы.',
  },
  {
    q: 'Есть ли обмен?',
